  ...
  const steps = [
    {
      ...
      description:
        "The journey to perfect walls begins here. Our expert team takes the time to deeply understand your project requirements, whether you're dealing with a minor repair or planning a multi-floor commercial installation. We'll discuss your timeline, specific requirements, and any unique challenges your project might present. Within 24 hours, you'll receive a comprehensive quote that breaks down every aspect of the work, ensuring complete transparency from day one.",
    },
    {
      icon: ClipboardCheck,
      number: "02",
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">
            6 STEPS TO PROJECT SUCCESS
          </h2>
          <div className="flex items-center justify-center mb-6">
            <div className="h-px w-12 bg-yellow-500"></div>
            <p className="mx-4 text-lg">
              From Small Repairs to Enterprise Solutions
            </p>
            <div className="h-px w-12 bg-yellow-500"></div>
          </div>

          {/* Company Vehicle Image Section */}
          <div className="mb-8 relative h-[300px] max-w-2xl mx-auto">
            <Image
              src="/photos/homepage/ourcar.webp"
              alt="Century Drywall Company Vehicle"
              fill
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            Our refined six-step process represents decades of industry
            expertise, designed to deliver exceptional results across Vancouver
            and Burnaby. Every step is carefully crafted to ensure superior
              ...
              return (
                <div key={index} className="relative">
                  ...
                  >
                    ...
                    {/* Content */}
                    <div
                      className={`flex-grow md:max-w-xl ${
