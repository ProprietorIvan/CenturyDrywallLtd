  ...
  const services: Service[] = [
    {
      ...
      description:
        "From single room repairs to complete home renovations, our expert team delivers flawless results for homeowners across Vancouver and Burnaby.",
    ...
    },
    {
      ...
      description:
        "Specializing in large-scale commercial projects, we bring efficiency and expertise to office buildings, retail spaces, and industrial facilities throughout the Lower Mainland.",
    ...
    },
    {
      ...
      description:
        "Partner with Vancouver's leading drywall experts for your new construction project. We work seamlessly with developers and contractors across Vancouver and Burnaby.",
    ...
    },
    {
      ...
      description:
        "Elevate your spaces with our specialty drywall finishes. From custom textures to Level 5 finishes for high-end properties in Vancouver and Burnaby.",
      ...
      <div className="bg-black w-full py-12 px-4">
        <div className="max-w-6xl mx-auto text-center space-y-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-12">
            Vancouver & Burnaby&#39;s Premier Drywall Specialists
          </h1>
          ...
          <div className="flex justify-center">
            <button
              onClick={() => copyToClipboard("info@burnabydrywall.ca", false)}
              className={`${
                copiedEmail
          ...
          <div className="relative">
            {services.map((service, index) => (
              ...
              >
                ...
                {/* Content Side */}
                <div
                  className={`w-full lg:w-1/2 bg-white p-8 lg:p-12 rounded-xl shadow-xl ${
